...
cc.Class({
    ...
    _initTableView: function () {
        ...
        if (this.horizontal) {
            ...
            this.content.height = this._cellSize.height;
            ...
            this.content.y = (this.content.anchorY - this._view.anchorY) * this.content.height;
            ...
            this.content.width = this._cellSize.width;
            ...
            this.content.x = (this.content.anchorX - this._view.anchorX) * this.content.width;
    ...
    initTableView: function (count, data) {
        ...
        if (!this._initSuccess) {
            ...
            // this.content = this._view.children[0];
    ...
    //     var offset = this.getScrollOffset();
    //     var p = cc.pSub(offset, this._lastOffset);
    //     if (this.ScrollModel == ScrollModel.Horizontal) {
    //         if (p.x > 0) {
    //             this._scrollDirection = ScrollDirection.Rigth;
    //         } else if (p.x < 0) {
